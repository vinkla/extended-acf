> **Note** The package **has been renamed** in version 13, see the [upgrade guide](#upgrade-guide).
...
"repositories": [
    {
        ...
        "package": {
            ...
            "version": "6.0",
            "dist": {
                "url": "https://connect.advancedcustomfields.com/v2/plugins/download?p=pro&k=YOUR-ACF-KEY&t=6.0",
                "type": "zip"
            }
        }
    }
